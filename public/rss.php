...
$rssBridgeDir = dirname(__DIR__) . '/library/rss-bridge/';
define('CACHE_DIR', $rssBridgeDir . 'cache');


// Specify path for whitelist file
define('WHITELIST_FILE', $rssBridgeDir . '/whitelist.txt');
...
require_once $rssBridgeDir . 'lib/RssBridge.php';
...
try {
	...
	Bridge::setDir($rssBridgeDir . 'bridges/');
	Format::setDir($rssBridgeDir . 'formats/');
	Cache::setDir($rssBridgeDir . 'caches/');
...
<head>
	...
	<link href="../library/rss-bridge/static/style.css" rel="stylesheet">
	<script src="../library/rss-bridge/static/search.js"></script>
	<script src="../library/rss-bridge/static/select.js"></script>
	<noscript>
		<style>
			.searchbar {
				display: none;
